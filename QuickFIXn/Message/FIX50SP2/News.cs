...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class News : Message
		{
			...
			public void Set(QuickFix.Fields.NoLinesOfText val) { this.NoLinesOfText = val; }
			...
			public bool IsSet(QuickFix.Fields.NoLinesOfText val) { return IsSetNoLinesOfText(); }
			...
			public void Set(QuickFix.Fields.NewsID val) { this.NewsID = val; }
			...
			public bool IsSet(QuickFix.Fields.NewsID val) { return IsSetNewsID(); }
			...
			public void Set(QuickFix.Fields.NoNewsRefIDs val) { this.NoNewsRefIDs = val; }
			...
			public bool IsSet(QuickFix.Fields.NoNewsRefIDs val) { return IsSetNoNewsRefIDs(); }
			...
			public void Set(QuickFix.Fields.NewsCategory val) { this.NewsCategory = val; }
			...
			public bool IsSet(QuickFix.Fields.NewsCategory val) { return IsSetNewsCategory(); }
			...
			public void Set(QuickFix.Fields.LanguageCode val) { this.LanguageCode = val; }
			...
			public bool IsSet(QuickFix.Fields.LanguageCode val) { return IsSetLanguageCode(); }
			...
			public class NoLinesOfTextGroup : Group
			{
				...
				public NoLinesOfTextGroup() : base(Tags.NoLinesOfText, Tags.Text, fieldOrder)
				{
				}
			...
			public class NoNewsRefIDsGroup : Group
			{
				...
				public NoNewsRefIDsGroup() : base(Tags.NoNewsRefIDs, Tags.NewsRefID, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.NewsRefID val) { this.NewsRefID = val; }
			...
			public bool IsSet(QuickFix.Fields.NewsRefID val) { return IsSetNewsRefID(); }
			...
			public void Set(QuickFix.Fields.NewsRefType val) { this.NewsRefType = val; }
			...
			public bool IsSet(QuickFix.Fields.NewsRefType val) { return IsSetNewsRefType(); }
