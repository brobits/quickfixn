...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class QuoteResponse : Message
		{
			...
			public QuoteResponse(QuickFix.Fields.QuoteRespID aQuoteRespID,
			...
			public void Set(QuickFix.Fields.QuoteRespType val) { this.QuoteRespType = val; }
			...
			public bool IsSet(QuickFix.Fields.QuoteRespType val) { return IsSetQuoteRespType(); }
