...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class PositionMaintenanceReport : Message
		{
			...
			public PositionMaintenanceReport(QuickFix.Fields.PosMaintRptID aPosMaintRptID,
			...
			public void Set(QuickFix.Fields.PosTransType val) { this.PosTransType = val; }
			...
			public bool IsSet(QuickFix.Fields.PosTransType val) { return IsSetPosTransType(); }
			...
			public void Set(QuickFix.Fields.PosMaintAction val) { this.PosMaintAction = val; }
			...
			public bool IsSet(QuickFix.Fields.PosMaintAction val) { return IsSetPosMaintAction(); }
			...
			public void Set(QuickFix.Fields.OrigPosReqRefID val) { this.OrigPosReqRefID = val; }
			...
			public bool IsSet(QuickFix.Fields.OrigPosReqRefID val) { return IsSetOrigPosReqRefID(); }
			...
			public void Set(QuickFix.Fields.PosMaintStatus val) { this.PosMaintStatus = val; }
			...
			public bool IsSet(QuickFix.Fields.PosMaintStatus val) { return IsSetPosMaintStatus(); }
			...
			public void Set(QuickFix.Fields.PosMaintResult val) { this.PosMaintResult = val; }
			...
			public bool IsSet(QuickFix.Fields.PosMaintResult val) { return IsSetPosMaintResult(); }
			...
			public void Set(QuickFix.Fields.AdjustmentType val) { this.AdjustmentType = val; }
			...
			public bool IsSet(QuickFix.Fields.AdjustmentType val) { return IsSetAdjustmentType(); }
			...
			public void Set(QuickFix.Fields.ThresholdAmount val) { this.ThresholdAmount = val; }
			...
			public bool IsSet(QuickFix.Fields.ThresholdAmount val) { return IsSetThresholdAmount(); }
			...
			public void Set(QuickFix.Fields.ContraryInstructionIndicator val) { this.ContraryInstructionIndicator = val; }
			...
			public bool IsSet(QuickFix.Fields.ContraryInstructionIndicator val) { return IsSetContraryInstructionIndicator(); }
			...
			public void Set(QuickFix.Fields.PriorSpreadIndicator val) { this.PriorSpreadIndicator = val; }
			...
			public bool IsSet(QuickFix.Fields.PriorSpreadIndicator val) { return IsSetPriorSpreadIndicator(); }
