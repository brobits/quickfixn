...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class SecurityListUpdateReport : Message
		{
			...
			public void Set(QuickFix.Fields.SecurityListID val) { this.SecurityListID = val; }
			...
			public bool IsSet(QuickFix.Fields.SecurityListID val) { return IsSetSecurityListID(); }
			...
			public void Set(QuickFix.Fields.SecurityListRefID val) { this.SecurityListRefID = val; }
			...
			public bool IsSet(QuickFix.Fields.SecurityListRefID val) { return IsSetSecurityListRefID(); }
			...
			public void Set(QuickFix.Fields.SecurityListDesc val) { this.SecurityListDesc = val; }
			...
			public bool IsSet(QuickFix.Fields.SecurityListDesc val) { return IsSetSecurityListDesc(); }
			...
			public void Set(QuickFix.Fields.EncodedSecurityListDescLen val) { this.EncodedSecurityListDescLen = val; }
			...
			public bool IsSet(QuickFix.Fields.EncodedSecurityListDescLen val) { return IsSetEncodedSecurityListDescLen(); }
			...
			public void Set(QuickFix.Fields.EncodedSecurityListDesc val) { this.EncodedSecurityListDesc = val; }
			...
			public bool IsSet(QuickFix.Fields.EncodedSecurityListDesc val) { return IsSetEncodedSecurityListDesc(); }
			...
			public void Set(QuickFix.Fields.SecurityListType val) { this.SecurityListType = val; }
			...
			public bool IsSet(QuickFix.Fields.SecurityListType val) { return IsSetSecurityListType(); }
			...
			public void Set(QuickFix.Fields.SecurityListTypeSource val) { this.SecurityListTypeSource = val; }
			...
			public bool IsSet(QuickFix.Fields.SecurityListTypeSource val) { return IsSetSecurityListTypeSource(); }
