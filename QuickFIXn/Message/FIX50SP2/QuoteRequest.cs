...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class QuoteRequest : Message
		{
			...
			public void Set(QuickFix.Fields.RespondentType val) { this.RespondentType = val; }
			...
			public bool IsSet(QuickFix.Fields.RespondentType val) { return IsSetRespondentType(); }
			...
			public void Set(QuickFix.Fields.QuotePriceType val) { this.QuotePriceType = val; }
			...
			public bool IsSet(QuickFix.Fields.QuotePriceType val) { return IsSetQuotePriceType(); }
