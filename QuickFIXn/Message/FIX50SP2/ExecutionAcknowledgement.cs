...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class ExecutionAcknowledgement : Message
		{
			...
			public ExecutionAcknowledgement(QuickFix.Fields.OrderID aOrderID,
			...
			public void Set(QuickFix.Fields.ExecAckStatus val) { this.ExecAckStatus = val; }
			...
			public bool IsSet(QuickFix.Fields.ExecAckStatus val) { return IsSetExecAckStatus(); }
