...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class MarketDataIncrementalRefresh : Message
		{
			...
			public void Set(QuickFix.Fields.ApplQueueDepth val) { this.ApplQueueDepth = val; }
			...
			public bool IsSet(QuickFix.Fields.ApplQueueDepth val) { return IsSetApplQueueDepth(); }
			...
			public void Set(QuickFix.Fields.ApplQueueResolution val) { this.ApplQueueResolution = val; }
			...
			public bool IsSet(QuickFix.Fields.ApplQueueResolution val) { return IsSetApplQueueResolution(); }
			...
			public void Set(QuickFix.Fields.OpenCloseSettlFlag val) { this.OpenCloseSettlFlag = val; }
			...
			public bool IsSet(QuickFix.Fields.OpenCloseSettlFlag val) { return IsSetOpenCloseSettlFlag(); }
			...
			public void Set(QuickFix.Fields.MDOriginType val) { this.MDOriginType = val; }
			...
			public bool IsSet(QuickFix.Fields.MDOriginType val) { return IsSetMDOriginType(); }
			...
			public void Set(QuickFix.Fields.TradeVolume val) { this.TradeVolume = val; }
			...
			public bool IsSet(QuickFix.Fields.TradeVolume val) { return IsSetTradeVolume(); }
			...
			public void Set(QuickFix.Fields.MDQuoteType val) { this.MDQuoteType = val; }
			...
			public bool IsSet(QuickFix.Fields.MDQuoteType val) { return IsSetMDQuoteType(); }
			...
			public void Set(QuickFix.Fields.DealingCapacity val) { this.DealingCapacity = val; }
			...
			public bool IsSet(QuickFix.Fields.DealingCapacity val) { return IsSetDealingCapacity(); }
			...
			public void Set(QuickFix.Fields.MDEntrySpotRate val) { this.MDEntrySpotRate = val; }
			...
			public bool IsSet(QuickFix.Fields.MDEntrySpotRate val) { return IsSetMDEntrySpotRate(); }
			...
			public void Set(QuickFix.Fields.MDEntryForwardPoints val) { this.MDEntryForwardPoints = val; }
			...
			public bool IsSet(QuickFix.Fields.MDEntryForwardPoints val) { return IsSetMDEntryForwardPoints(); }
			...
			public void Set(QuickFix.Fields.MDPriceLevel val) { this.MDPriceLevel = val; }
			...
			public bool IsSet(QuickFix.Fields.MDPriceLevel val) { return IsSetMDPriceLevel(); }
			...
			public void Set(QuickFix.Fields.MDSubBookType val) { this.MDSubBookType = val; }
			...
			public bool IsSet(QuickFix.Fields.MDSubBookType val) { return IsSetMDSubBookType(); }
			...
			public void Set(QuickFix.Fields.NoOfSecSizes val) { this.NoOfSecSizes = val; }
			...
			public bool IsSet(QuickFix.Fields.NoOfSecSizes val) { return IsSetNoOfSecSizes(); }
			...
			public void Set(QuickFix.Fields.HaltReasonInt val) { this.HaltReasonInt = val; }
			...
			public bool IsSet(QuickFix.Fields.HaltReasonInt val) { return IsSetHaltReasonInt(); }
			...
			public void Set(QuickFix.Fields.NoStatsIndicators val) { this.NoStatsIndicators = val; }
			...
			public bool IsSet(QuickFix.Fields.NoStatsIndicators val) { return IsSetNoStatsIndicators(); }
			...
			public void Set(QuickFix.Fields.NoRateSources val) { this.NoRateSources = val; }
			...
			public bool IsSet(QuickFix.Fields.NoRateSources val) { return IsSetNoRateSources(); }
			...
			public void Set(QuickFix.Fields.FirstPx val) { this.FirstPx = val; }
			...
			public bool IsSet(QuickFix.Fields.FirstPx val) { return IsSetFirstPx(); }
			...
			public void Set(QuickFix.Fields.MDStreamID val) { this.MDStreamID = val; }
			...
			public bool IsSet(QuickFix.Fields.MDStreamID val) { return IsSetMDStreamID(); }
			...
			public class NoOfSecSizesGroup : Group
			{
				...
				public NoOfSecSizesGroup() : base(Tags.NoOfSecSizes, Tags.MDSecSizeType, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.MDSecSizeType val) { this.MDSecSizeType = val; }
			...
			public bool IsSet(QuickFix.Fields.MDSecSizeType val) { return IsSetMDSecSizeType(); }
			...
			public void Set(QuickFix.Fields.MDSecSize val) { this.MDSecSize = val; }
			...
			public bool IsSet(QuickFix.Fields.MDSecSize val) { return IsSetMDSecSize(); }
			...
			public class NoStatsIndicatorsGroup : Group
			{
				...
				public NoStatsIndicatorsGroup() : base(Tags.NoStatsIndicators, Tags.StatsType, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.StatsType val) { this.StatsType = val; }
			...
			public bool IsSet(QuickFix.Fields.StatsType val) { return IsSetStatsType(); }
			...
			public class NoRateSourcesGroup : Group
			{
				...
				public NoRateSourcesGroup() : base(Tags.NoRateSources, Tags.RateSource, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.RateSource val) { this.RateSource = val; }
			...
			public bool IsSet(QuickFix.Fields.RateSource val) { return IsSetRateSource(); }
			...
			public void Set(QuickFix.Fields.RateSourceType val) { this.RateSourceType = val; }
			...
			public bool IsSet(QuickFix.Fields.RateSourceType val) { return IsSetRateSourceType(); }
			...
			public void Set(QuickFix.Fields.ReferencePage val) { this.ReferencePage = val; }
			...
			public bool IsSet(QuickFix.Fields.ReferencePage val) { return IsSetReferencePage(); }
