...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class ExecutionReport : Message
		{
			...
			public void Set(QuickFix.Fields.FillLiquidityInd val) { this.FillLiquidityInd = val; }
			...
			public bool IsSet(QuickFix.Fields.FillLiquidityInd val) { return IsSetFillLiquidityInd(); }
