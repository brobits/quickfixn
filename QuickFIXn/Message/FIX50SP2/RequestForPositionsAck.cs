...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class RequestForPositionsAck : Message
		{
			...
			public RequestForPositionsAck(QuickFix.Fields.PosMaintRptID aPosMaintRptID,
			...
			public void Set(QuickFix.Fields.PosReqStatus val) { this.PosReqStatus = val; }
			...
			public bool IsSet(QuickFix.Fields.PosReqStatus val) { return IsSetPosReqStatus(); }
