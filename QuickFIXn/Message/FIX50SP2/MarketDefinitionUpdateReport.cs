...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class MarketDefinitionUpdateReport : Message
		{
			...
			public MarketDefinitionUpdateReport(QuickFix.Fields.MarketReportID aMarketReportID,
			...
			public void Set(QuickFix.Fields.MarketReportID val) { this.MarketReportID = val; }
			...
			public bool IsSet(QuickFix.Fields.MarketReportID val) { return IsSetMarketReportID(); }
			...
			public void Set(QuickFix.Fields.MarketUpdateAction val) { this.MarketUpdateAction = val; }
			...
			public bool IsSet(QuickFix.Fields.MarketUpdateAction val) { return IsSetMarketUpdateAction(); }
			...
			public void Set(QuickFix.Fields.MarketSegmentDesc val) { this.MarketSegmentDesc = val; }
			...
			public bool IsSet(QuickFix.Fields.MarketSegmentDesc val) { return IsSetMarketSegmentDesc(); }
			...
			public void Set(QuickFix.Fields.EncodedMktSegmDescLen val) { this.EncodedMktSegmDescLen = val; }
			...
			public bool IsSet(QuickFix.Fields.EncodedMktSegmDescLen val) { return IsSetEncodedMktSegmDescLen(); }
			...
			public void Set(QuickFix.Fields.EncodedMktSegmDesc val) { this.EncodedMktSegmDesc = val; }
			...
			public bool IsSet(QuickFix.Fields.EncodedMktSegmDesc val) { return IsSetEncodedMktSegmDesc(); }
