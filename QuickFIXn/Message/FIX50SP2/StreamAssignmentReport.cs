...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class StreamAssignmentReport : Message
		{
			...
			public StreamAssignmentReport(QuickFix.Fields.StreamAsgnRptID aStreamAsgnRptID)
				   : this()
			{
			...
			public void Set(QuickFix.Fields.StreamAsgnReqType val) { this.StreamAsgnReqType = val; }
			...
			public bool IsSet(QuickFix.Fields.StreamAsgnReqType val) { return IsSetStreamAsgnReqType(); }
			...
			public void Set(QuickFix.Fields.StreamAsgnReqID val) { this.StreamAsgnReqID = val; }
			...
			public bool IsSet(QuickFix.Fields.StreamAsgnReqID val) { return IsSetStreamAsgnReqID(); }
			...
			public void Set(QuickFix.Fields.NoAsgnReqs val) { this.NoAsgnReqs = val; }
			...
			public bool IsSet(QuickFix.Fields.NoAsgnReqs val) { return IsSetNoAsgnReqs(); }
			...
			public class NoAsgnReqsGroup : Group
			{
				...
				public NoAsgnReqsGroup() : base(Tags.NoAsgnReqs, Tags.NoPartyIDs, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.StreamAsgnType val) { this.StreamAsgnType = val; }
			...
			public bool IsSet(QuickFix.Fields.StreamAsgnType val) { return IsSetStreamAsgnType(); }
