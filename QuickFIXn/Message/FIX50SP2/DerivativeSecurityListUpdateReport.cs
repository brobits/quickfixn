...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class DerivativeSecurityListUpdateReport : Message
		{
			...
			public void Set(QuickFix.Fields.DerivativeValuationMethod val) { this.DerivativeValuationMethod = val; }
			...
			public bool IsSet(QuickFix.Fields.DerivativeValuationMethod val) { return IsSetDerivativeValuationMethod(); }
			...
			public void Set(QuickFix.Fields.DerivativeContractMultiplierUnit val) { this.DerivativeContractMultiplierUnit = val; }
			...
			public bool IsSet(QuickFix.Fields.DerivativeContractMultiplierUnit val) { return IsSetDerivativeContractMultiplierUnit(); }
			...
			public void Set(QuickFix.Fields.DerivativeFlowScheduleType val) { this.DerivativeFlowScheduleType = val; }
			...
			public bool IsSet(QuickFix.Fields.DerivativeFlowScheduleType val) { return IsSetDerivativeFlowScheduleType(); }
			...
			public void Set(QuickFix.Fields.NoDerivativeInstrAttrib val) { this.NoDerivativeInstrAttrib = val; }
			...
			public bool IsSet(QuickFix.Fields.NoDerivativeInstrAttrib val) { return IsSetNoDerivativeInstrAttrib(); }
			...
			public void Set(QuickFix.Fields.TotNoRelatedSym val) { this.TotNoRelatedSym = val; }
			...
			public bool IsSet(QuickFix.Fields.TotNoRelatedSym val) { return IsSetTotNoRelatedSym(); }
			...
			public class NoDerivativeInstrAttribGroup : Group
			{
				...
				public NoDerivativeInstrAttribGroup() : base(Tags.NoDerivativeInstrAttrib, Tags.DerivativeInstrAttribType, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.DerivativeInstrAttribType val) { this.DerivativeInstrAttribType = val; }
			...
			public bool IsSet(QuickFix.Fields.DerivativeInstrAttribType val) { return IsSetDerivativeInstrAttribType(); }
			...
			public void Set(QuickFix.Fields.DerivativeInstrAttribValue val) { this.DerivativeInstrAttribValue = val; }
			...
			public bool IsSet(QuickFix.Fields.DerivativeInstrAttribValue val) { return IsSetDerivativeInstrAttribValue(); }
			...
			public class NoRelatedSymGroup : Group
			{
				...
				public NoRelatedSymGroup() : base(Tags.NoRelatedSym, Tags.ListUpdateAction, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.ListUpdateAction val) { this.ListUpdateAction = val; }
			...
			public bool IsSet(QuickFix.Fields.ListUpdateAction val) { return IsSetListUpdateAction(); }
			...
			public void Set(QuickFix.Fields.SecondaryPriceLimitType val) { this.SecondaryPriceLimitType = val; }
			...
			public bool IsSet(QuickFix.Fields.SecondaryPriceLimitType val) { return IsSetSecondaryPriceLimitType(); }
			...
			public void Set(QuickFix.Fields.SecondaryLowLimitPrice val) { this.SecondaryLowLimitPrice = val; }
			...
			public bool IsSet(QuickFix.Fields.SecondaryLowLimitPrice val) { return IsSetSecondaryLowLimitPrice(); }
			...
			public void Set(QuickFix.Fields.SecondaryHighLimitPrice val) { this.SecondaryHighLimitPrice = val; }
			...
			public bool IsSet(QuickFix.Fields.SecondaryHighLimitPrice val) { return IsSetSecondaryHighLimitPrice(); }
			...
			public void Set(QuickFix.Fields.SecondaryTradingReferencePrice val) { this.SecondaryTradingReferencePrice = val; }
			...
			public bool IsSet(QuickFix.Fields.SecondaryTradingReferencePrice val) { return IsSetSecondaryTradingReferencePrice(); }
			...
			public void Set(QuickFix.Fields.RelSymTransactTime val) { this.RelSymTransactTime = val; }
			...
			public bool IsSet(QuickFix.Fields.RelSymTransactTime val) { return IsSetRelSymTransactTime(); }
