...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class AssignmentReport : Message
		{
			...
			public AssignmentReport(QuickFix.Fields.AsgnRptID aAsgnRptID,
			...
			public void Set(QuickFix.Fields.AsgnRptID val) { this.AsgnRptID = val; }
			...
			public bool IsSet(QuickFix.Fields.AsgnRptID val) { return IsSetAsgnRptID(); }
			...
			public void Set(QuickFix.Fields.TotNumAssignmentReports val) { this.TotNumAssignmentReports = val; }
			...
			public bool IsSet(QuickFix.Fields.TotNumAssignmentReports val) { return IsSetTotNumAssignmentReports(); }
			...
			public void Set(QuickFix.Fields.AssignmentMethod val) { this.AssignmentMethod = val; }
			...
			public bool IsSet(QuickFix.Fields.AssignmentMethod val) { return IsSetAssignmentMethod(); }
			...
			public void Set(QuickFix.Fields.AssignmentUnit val) { this.AssignmentUnit = val; }
			...
			public bool IsSet(QuickFix.Fields.AssignmentUnit val) { return IsSetAssignmentUnit(); }
			...
			public void Set(QuickFix.Fields.OpenInterest val) { this.OpenInterest = val; }
			...
			public bool IsSet(QuickFix.Fields.OpenInterest val) { return IsSetOpenInterest(); }
			...
			public void Set(QuickFix.Fields.ExerciseMethod val) { this.ExerciseMethod = val; }
			...
			public bool IsSet(QuickFix.Fields.ExerciseMethod val) { return IsSetExerciseMethod(); }
