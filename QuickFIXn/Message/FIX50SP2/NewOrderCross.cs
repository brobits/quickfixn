...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class NewOrderCross : Message
		{
			...
			public NewOrderCross(QuickFix.Fields.CrossID aCrossID,
			...
			public void Set(QuickFix.Fields.SideTimeInForce val) { this.SideTimeInForce = val; }
			...
			public bool IsSet(QuickFix.Fields.SideTimeInForce val) { return IsSetSideTimeInForce(); }
