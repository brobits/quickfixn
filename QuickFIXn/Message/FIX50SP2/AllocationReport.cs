...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class AllocationReport : Message
		{
			...
			public AllocationReport(QuickFix.Fields.AllocReportID aAllocReportID,
			...
			public void Set(QuickFix.Fields.AllocReportRefID val) { this.AllocReportRefID = val; }
			...
			public bool IsSet(QuickFix.Fields.AllocReportRefID val) { return IsSetAllocReportRefID(); }
