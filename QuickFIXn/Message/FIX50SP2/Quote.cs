...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class Quote : Message
		{
			...
			public void Set(QuickFix.Fields.NoQuoteQualifiers val) { this.NoQuoteQualifiers = val; }
			...
			public bool IsSet(QuickFix.Fields.NoQuoteQualifiers val) { return IsSetNoQuoteQualifiers(); }
			...
			public void Set(QuickFix.Fields.BidSwapPoints val) { this.BidSwapPoints = val; }
			...
			public bool IsSet(QuickFix.Fields.BidSwapPoints val) { return IsSetBidSwapPoints(); }
			...
			public void Set(QuickFix.Fields.OfferSwapPoints val) { this.OfferSwapPoints = val; }
			...
			public bool IsSet(QuickFix.Fields.OfferSwapPoints val) { return IsSetOfferSwapPoints(); }
			...
			public void Set(QuickFix.Fields.QuoteMsgID val) { this.QuoteMsgID = val; }
			...
			public bool IsSet(QuickFix.Fields.QuoteMsgID val) { return IsSetQuoteMsgID(); }
			...
			public void Set(QuickFix.Fields.PrivateQuote val) { this.PrivateQuote = val; }
			...
			public bool IsSet(QuickFix.Fields.PrivateQuote val) { return IsSetPrivateQuote(); }
			...
			public class NoQuoteQualifiersGroup : Group
			{
				...
				public NoQuoteQualifiersGroup() : base(Tags.NoQuoteQualifiers, Tags.QuoteQualifier, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.QuoteQualifier val) { this.QuoteQualifier = val; }
			...
			public bool IsSet(QuickFix.Fields.QuoteQualifier val) { return IsSetQuoteQualifier(); }
			...
			public void Set(QuickFix.Fields.LegPriceType val) { this.LegPriceType = val; }
			...
			public bool IsSet(QuickFix.Fields.LegPriceType val) { return IsSetLegPriceType(); }
			...
			public void Set(QuickFix.Fields.LegBidPx val) { this.LegBidPx = val; }
			...
			public bool IsSet(QuickFix.Fields.LegBidPx val) { return IsSetLegBidPx(); }
			...
			public void Set(QuickFix.Fields.LegOfferPx val) { this.LegOfferPx = val; }
			...
			public bool IsSet(QuickFix.Fields.LegOfferPx val) { return IsSetLegOfferPx(); }
			...
			public void Set(QuickFix.Fields.LegBenchmarkCurveCurrency val) { this.LegBenchmarkCurveCurrency = val; }
			...
			public bool IsSet(QuickFix.Fields.LegBenchmarkCurveCurrency val) { return IsSetLegBenchmarkCurveCurrency(); }
			...
			public void Set(QuickFix.Fields.LegBenchmarkCurveName val) { this.LegBenchmarkCurveName = val; }
			...
			public bool IsSet(QuickFix.Fields.LegBenchmarkCurveName val) { return IsSetLegBenchmarkCurveName(); }
			...
			public void Set(QuickFix.Fields.LegBenchmarkCurvePoint val) { this.LegBenchmarkCurvePoint = val; }
			...
			public bool IsSet(QuickFix.Fields.LegBenchmarkCurvePoint val) { return IsSetLegBenchmarkCurvePoint(); }
			...
			public void Set(QuickFix.Fields.LegBenchmarkPrice val) { this.LegBenchmarkPrice = val; }
			...
			public bool IsSet(QuickFix.Fields.LegBenchmarkPrice val) { return IsSetLegBenchmarkPrice(); }
			...
			public void Set(QuickFix.Fields.LegBenchmarkPriceType val) { this.LegBenchmarkPriceType = val; }
			...
			public bool IsSet(QuickFix.Fields.LegBenchmarkPriceType val) { return IsSetLegBenchmarkPriceType(); }
			...
			public void Set(QuickFix.Fields.LegBidForwardPoints val) { this.LegBidForwardPoints = val; }
			...
			public bool IsSet(QuickFix.Fields.LegBidForwardPoints val) { return IsSetLegBidForwardPoints(); }
			...
			public void Set(QuickFix.Fields.LegOfferForwardPoints val) { this.LegOfferForwardPoints = val; }
			...
			public bool IsSet(QuickFix.Fields.LegOfferForwardPoints val) { return IsSetLegOfferForwardPoints(); }
