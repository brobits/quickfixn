...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class MarketDataSnapshotFullRefresh : Message
		{
			...
			public void Set(QuickFix.Fields.MDReportID val) { this.MDReportID = val; }
			...
			public bool IsSet(QuickFix.Fields.MDReportID val) { return IsSetMDReportID(); }
			...
			public void Set(QuickFix.Fields.RefreshIndicator val) { this.RefreshIndicator = val; }
			...
			public bool IsSet(QuickFix.Fields.RefreshIndicator val) { return IsSetRefreshIndicator(); }
