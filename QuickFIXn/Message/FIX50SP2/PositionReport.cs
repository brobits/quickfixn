...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class PositionReport : Message
		{
			...
			public PositionReport(QuickFix.Fields.PosMaintRptID aPosMaintRptID,
			...
			public void Set(QuickFix.Fields.PosReqID val) { this.PosReqID = val; }
			...
			public bool IsSet(QuickFix.Fields.PosReqID val) { return IsSetPosReqID(); }
			...
			public void Set(QuickFix.Fields.TotalNumPosReports val) { this.TotalNumPosReports = val; }
			...
			public bool IsSet(QuickFix.Fields.TotalNumPosReports val) { return IsSetTotalNumPosReports(); }
			...
			public void Set(QuickFix.Fields.PosReqResult val) { this.PosReqResult = val; }
			...
			public bool IsSet(QuickFix.Fields.PosReqResult val) { return IsSetPosReqResult(); }
			...
			public void Set(QuickFix.Fields.SettlPriceType val) { this.SettlPriceType = val; }
			...
			public bool IsSet(QuickFix.Fields.SettlPriceType val) { return IsSetSettlPriceType(); }
			...
			public void Set(QuickFix.Fields.DeliveryDate val) { this.DeliveryDate = val; }
			...
			public bool IsSet(QuickFix.Fields.DeliveryDate val) { return IsSetDeliveryDate(); }
			...
			public void Set(QuickFix.Fields.ModelType val) { this.ModelType = val; }
			...
			public bool IsSet(QuickFix.Fields.ModelType val) { return IsSetModelType(); }
			...
			public void Set(QuickFix.Fields.UnderlyingSettlPrice val) { this.UnderlyingSettlPrice = val; }
			...
			public bool IsSet(QuickFix.Fields.UnderlyingSettlPrice val) { return IsSetUnderlyingSettlPrice(); }
			...
			public void Set(QuickFix.Fields.UnderlyingSettlPriceType val) { this.UnderlyingSettlPriceType = val; }
			...
			public bool IsSet(QuickFix.Fields.UnderlyingSettlPriceType val) { return IsSetUnderlyingSettlPriceType(); }
			...
			public void Set(QuickFix.Fields.NoUnderlyingAmounts val) { this.NoUnderlyingAmounts = val; }
			...
			public bool IsSet(QuickFix.Fields.NoUnderlyingAmounts val) { return IsSetNoUnderlyingAmounts(); }
			...
			public void Set(QuickFix.Fields.UnderlyingDeliveryAmount val) { this.UnderlyingDeliveryAmount = val; }
			...
			public bool IsSet(QuickFix.Fields.UnderlyingDeliveryAmount val) { return IsSetUnderlyingDeliveryAmount(); }
			...
			public class NoUnderlyingAmountsGroup : Group
			{
				...
				public NoUnderlyingAmountsGroup() : base(Tags.NoUnderlyingAmounts, Tags.UnderlyingPayAmount, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.UnderlyingPayAmount val) { this.UnderlyingPayAmount = val; }
			...
			public bool IsSet(QuickFix.Fields.UnderlyingPayAmount val) { return IsSetUnderlyingPayAmount(); }
			...
			public void Set(QuickFix.Fields.UnderlyingCollectAmount val) { this.UnderlyingCollectAmount = val; }
			...
			public bool IsSet(QuickFix.Fields.UnderlyingCollectAmount val) { return IsSetUnderlyingCollectAmount(); }
			...
			public void Set(QuickFix.Fields.UnderlyingSettlementStatus val) { this.UnderlyingSettlementStatus = val; }
			...
			public bool IsSet(QuickFix.Fields.UnderlyingSettlementStatus val) { return IsSetUnderlyingSettlementStatus(); }
