...
namespace QuickFix
{
	namespace FIX50SP2
	{
		public class MarketDataRequest : Message
		{
			...
			public void Set(QuickFix.Fields.MDImplicitDelete val) { this.MDImplicitDelete = val; }
			...
			public bool IsSet(QuickFix.Fields.MDImplicitDelete val) { return IsSetMDImplicitDelete(); }
			...
			public void Set(QuickFix.Fields.ApplQueueAction val) { this.ApplQueueAction = val; }
			...
			public bool IsSet(QuickFix.Fields.ApplQueueAction val) { return IsSetApplQueueAction(); }
			...
			public void Set(QuickFix.Fields.ApplQueueMax val) { this.ApplQueueMax = val; }
			...
			public bool IsSet(QuickFix.Fields.ApplQueueMax val) { return IsSetApplQueueMax(); }
