...
namespace QuickFix
{
	namespace FIX44
	{
		public class ListStrikePrice : Message
		{
			...
			public ListStrikePrice(QuickFix.Fields.ListID aListID,
			...
			public void Set(QuickFix.Fields.TotNoStrikes val) { this.TotNoStrikes = val; }
			...
			public bool IsSet(QuickFix.Fields.TotNoStrikes val) { return IsSetTotNoStrikes(); }
			...
			public void Set(QuickFix.Fields.NoStrikes val) { this.NoStrikes = val; }
			...
			public bool IsSet(QuickFix.Fields.NoStrikes val) { return IsSetNoStrikes(); }
