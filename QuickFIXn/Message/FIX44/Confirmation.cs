...
namespace QuickFix
{
	namespace FIX44
	{
		public class Confirmation : Message
		{
			...
			public Confirmation(QuickFix.Fields.ConfirmID aConfirmID,
			...
			public void Set(QuickFix.Fields.ConfirmRefID val) { this.ConfirmRefID = val; }
			...
			public bool IsSet(QuickFix.Fields.ConfirmRefID val) { return IsSetConfirmRefID(); }
			...
			public void Set(QuickFix.Fields.ConfirmTransType val) { this.ConfirmTransType = val; }
			...
			public bool IsSet(QuickFix.Fields.ConfirmTransType val) { return IsSetConfirmTransType(); }
			...
			public void Set(QuickFix.Fields.ConfirmStatus val) { this.ConfirmStatus = val; }
			...
			public bool IsSet(QuickFix.Fields.ConfirmStatus val) { return IsSetConfirmStatus(); }
			...
			public void Set(QuickFix.Fields.NoCapacities val) { this.NoCapacities = val; }
			...
			public bool IsSet(QuickFix.Fields.NoCapacities val) { return IsSetNoCapacities(); }
			...
			public void Set(QuickFix.Fields.ReportedPx val) { this.ReportedPx = val; }
			...
			public bool IsSet(QuickFix.Fields.ReportedPx val) { return IsSetReportedPx(); }
			...
			public void Set(QuickFix.Fields.MaturityNetMoney val) { this.MaturityNetMoney = val; }
			...
			public bool IsSet(QuickFix.Fields.MaturityNetMoney val) { return IsSetMaturityNetMoney(); }
			...
			public void Set(QuickFix.Fields.SharedCommission val) { this.SharedCommission = val; }
			...
			public bool IsSet(QuickFix.Fields.SharedCommission val) { return IsSetSharedCommission(); }
			...
			public class NoCapacitiesGroup : Group
			{
				...
				public NoCapacitiesGroup() : base(Tags.NoCapacities, Tags.OrderCapacity, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.OrderCapacityQty val) { this.OrderCapacityQty = val; }
			...
			public bool IsSet(QuickFix.Fields.OrderCapacityQty val) { return IsSetOrderCapacityQty(); }
