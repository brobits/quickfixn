...
namespace QuickFix
{
	namespace FIX44
	{
		public class TradeCaptureReportRequest : Message
		{
			...
			public TradeCaptureReportRequest(QuickFix.Fields.TradeRequestID aTradeRequestID,
			...
			public void Set(QuickFix.Fields.NoDates val) { this.NoDates = val; }
			...
			public bool IsSet(QuickFix.Fields.NoDates val) { return IsSetNoDates(); }
			...
			public class NoDatesGroup : Group
			{
				...
				public NoDatesGroup() : base(Tags.NoDates, Tags.TradeDate, fieldOrder)
				{
				}
