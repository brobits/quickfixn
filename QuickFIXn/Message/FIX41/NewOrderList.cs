...
namespace QuickFix
{
	namespace FIX41
	{
		public class NewOrderList : Message
		{
			...
			public void Set(QuickFix.Fields.ListNoOrds val) { this.ListNoOrds = val; }
			...
			public bool IsSet(QuickFix.Fields.ListNoOrds val) { return IsSetListNoOrds(); }

			public bool IsSetListNoOrds() { return IsSetField(Tags.ListNoOrds); }
