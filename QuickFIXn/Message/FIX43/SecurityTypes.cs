...
namespace QuickFix
{
	namespace FIX43
	{
		public class SecurityTypes : Message
		{
			...
			public void Set(QuickFix.Fields.TotalNumSecurityTypes val) { this.TotalNumSecurityTypes = val; }
			...
			public bool IsSet(QuickFix.Fields.TotalNumSecurityTypes val) { return IsSetTotalNumSecurityTypes(); }
