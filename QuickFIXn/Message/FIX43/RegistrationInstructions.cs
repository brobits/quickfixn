	...
	namespace FIX43
	{
		public class RegistrationInstructions : Message
		{
			...
			public class NoRegistDtlsGroup : Group
			{
				...
				public NoRegistDtlsGroup() : base(Tags.NoRegistDtls, Tags.RegistDetls, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.RegistDetls val) { this.RegistDetls = val; }
			...
			public bool IsSet(QuickFix.Fields.RegistDetls val) { return IsSetRegistDetls(); }
