...
namespace QuickFix
{
	namespace FIX50SP1
	{
		public class OrderMassActionReport : Message
		{
			...
			public OrderMassActionReport(QuickFix.Fields.MassActionReportID aMassActionReportID,
			...
			public void Set(QuickFix.Fields.MassActionReportID val) { this.MassActionReportID = val; }
			...
			public bool IsSet(QuickFix.Fields.MassActionReportID val) { return IsSetMassActionReportID(); }
			...
			public void Set(QuickFix.Fields.MassActionType val) { this.MassActionType = val; }
			...
			public bool IsSet(QuickFix.Fields.MassActionType val) { return IsSetMassActionType(); }
			...
			public void Set(QuickFix.Fields.MassActionScope val) { this.MassActionScope = val; }
			...
			public bool IsSet(QuickFix.Fields.MassActionScope val) { return IsSetMassActionScope(); }
			...
			public void Set(QuickFix.Fields.MassActionResponse val) { this.MassActionResponse = val; }
			...
			public bool IsSet(QuickFix.Fields.MassActionResponse val) { return IsSetMassActionResponse(); }
			...
			public void Set(QuickFix.Fields.MassActionRejectReason val) { this.MassActionRejectReason = val; }
			...
			public bool IsSet(QuickFix.Fields.MassActionRejectReason val) { return IsSetMassActionRejectReason(); }
			...
			public void Set(QuickFix.Fields.TotalAffectedOrders val) { this.TotalAffectedOrders = val; }
			...
			public bool IsSet(QuickFix.Fields.TotalAffectedOrders val) { return IsSetTotalAffectedOrders(); }
			...
			public void Set(QuickFix.Fields.NoAffectedOrders val) { this.NoAffectedOrders = val; }
			...
			public bool IsSet(QuickFix.Fields.NoAffectedOrders val) { return IsSetNoAffectedOrders(); }
			...
			public void Set(QuickFix.Fields.NoNotAffectedOrders val) { this.NoNotAffectedOrders = val; }
			...
			public bool IsSet(QuickFix.Fields.NoNotAffectedOrders val) { return IsSetNoNotAffectedOrders(); }
			...
			public class NoAffectedOrdersGroup : Group
			{
				...
				public NoAffectedOrdersGroup() : base(Tags.NoAffectedOrders, Tags.OrigClOrdID, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.AffectedOrderID val) { this.AffectedOrderID = val; }
			...
			public bool IsSet(QuickFix.Fields.AffectedOrderID val) { return IsSetAffectedOrderID(); }
			...
			public void Set(QuickFix.Fields.AffectedSecondaryOrderID val) { this.AffectedSecondaryOrderID = val; }
			...
			public bool IsSet(QuickFix.Fields.AffectedSecondaryOrderID val) { return IsSetAffectedSecondaryOrderID(); }
			...
			public class NoNotAffectedOrdersGroup : Group
			{
				...
				public NoNotAffectedOrdersGroup() : base(Tags.NoNotAffectedOrders, Tags.NotAffOrigClOrdID, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.NotAffOrigClOrdID val) { this.NotAffOrigClOrdID = val; }
			...
			public bool IsSet(QuickFix.Fields.NotAffOrigClOrdID val) { return IsSetNotAffOrigClOrdID(); }
			...
			public void Set(QuickFix.Fields.NotAffectedOrderID val) { this.NotAffectedOrderID = val; }
			...
			public bool IsSet(QuickFix.Fields.NotAffectedOrderID val) { return IsSetNotAffectedOrderID(); }
