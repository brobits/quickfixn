	...
	namespace FIX50SP1
	{
		public class ContraryIntentionReport : Message
		{
			...
			public class NoExpirationGroup : Group
			{
				...
				public NoExpirationGroup() : base(Tags.NoExpiration, Tags.ExpirationQtyType, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.ExpirationQtyType val) { this.ExpirationQtyType = val; }
			...
			public bool IsSet(QuickFix.Fields.ExpirationQtyType val) { return IsSetExpirationQtyType(); }
