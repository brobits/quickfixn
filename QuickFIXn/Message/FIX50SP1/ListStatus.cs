...
namespace QuickFix
{
	namespace FIX50SP1
	{
		public class ListStatus : Message
		{
			...
			public void Set(QuickFix.Fields.ListStatusType val) { this.ListStatusType = val; }
			...
			public bool IsSet(QuickFix.Fields.ListStatusType val) { return IsSetListStatusType(); }
			...
			public void Set(QuickFix.Fields.ListOrderStatus val) { this.ListOrderStatus = val; }
			...
			public bool IsSet(QuickFix.Fields.ListOrderStatus val) { return IsSetListOrderStatus(); }
			...
			public void Set(QuickFix.Fields.ListStatusText val) { this.ListStatusText = val; }
			...
			public bool IsSet(QuickFix.Fields.ListStatusText val) { return IsSetListStatusText(); }
			...
			public void Set(QuickFix.Fields.EncodedListStatusTextLen val) { this.EncodedListStatusTextLen = val; }
			...
			public bool IsSet(QuickFix.Fields.EncodedListStatusTextLen val) { return IsSetEncodedListStatusTextLen(); }
			...
			public void Set(QuickFix.Fields.EncodedListStatusText val) { this.EncodedListStatusText = val; }
			...
			public bool IsSet(QuickFix.Fields.EncodedListStatusText val) { return IsSetEncodedListStatusText(); }
			...
			public void Set(QuickFix.Fields.ContingencyType val) { this.ContingencyType = val; }
			...
			public bool IsSet(QuickFix.Fields.ContingencyType val) { return IsSetContingencyType(); }
			...
			public void Set(QuickFix.Fields.ListRejectReason val) { this.ListRejectReason = val; }
			...
			public bool IsSet(QuickFix.Fields.ListRejectReason val) { return IsSetListRejectReason(); }
