...
namespace QuickFix
{
	namespace FIX50SP1
	{
		public class MarketDataIncrementalRefresh : Message
		{
			...
			public void Set(QuickFix.Fields.HaltReasonChar val) { this.HaltReasonChar = val; }
			...
			public bool IsSet(QuickFix.Fields.HaltReasonChar val) { return IsSetHaltReasonChar(); }
