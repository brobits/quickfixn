...
namespace QuickFix
{
	namespace FIX50SP1
	{
		public class OrderMassCancelReport : Message
		{
			...
			public OrderMassCancelReport(QuickFix.Fields.OrderID aOrderID,
			...
			public void Set(QuickFix.Fields.MassCancelRequestType val) { this.MassCancelRequestType = val; }
			...
			public bool IsSet(QuickFix.Fields.MassCancelRequestType val) { return IsSetMassCancelRequestType(); }
			...
			public void Set(QuickFix.Fields.MassCancelResponse val) { this.MassCancelResponse = val; }
			...
			public bool IsSet(QuickFix.Fields.MassCancelResponse val) { return IsSetMassCancelResponse(); }
			...
			public void Set(QuickFix.Fields.MassCancelRejectReason val) { this.MassCancelRejectReason = val; }
			...
			public bool IsSet(QuickFix.Fields.MassCancelRejectReason val) { return IsSetMassCancelRejectReason(); }
