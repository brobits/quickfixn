...
namespace QuickFix
{
	namespace FIX50SP1
	{
		public class SecurityStatus : Message
		{
			...
			public QuickFix.Fields.SecurityStatus SecurityStatusField
			{
				get
				{
			...
			public void Set(QuickFix.Fields.SecurityStatus val) { this.SecurityStatusField = val; }
			...
			public void Set(QuickFix.Fields.SecurityTradingEvent val) { this.SecurityTradingEvent = val; }
			...
			public bool IsSet(QuickFix.Fields.SecurityTradingEvent val) { return IsSetSecurityTradingEvent(); }
