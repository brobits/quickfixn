...
namespace QuickFix
{
	namespace FIX50SP1
	{
		public class Email : Message
		{
			...
			public Email(QuickFix.Fields.EmailThreadID aEmailThreadID,
			...
			public void Set(QuickFix.Fields.EmailThreadID val) { this.EmailThreadID = val; }
			...
			public bool IsSet(QuickFix.Fields.EmailThreadID val) { return IsSetEmailThreadID(); }
			...
			public void Set(QuickFix.Fields.Subject val) { this.Subject = val; }
			...
			public bool IsSet(QuickFix.Fields.Subject val) { return IsSetSubject(); }
			...
			public void Set(QuickFix.Fields.EncodedSubjectLen val) { this.EncodedSubjectLen = val; }
			...
			public bool IsSet(QuickFix.Fields.EncodedSubjectLen val) { return IsSetEncodedSubjectLen(); }
			...
			public void Set(QuickFix.Fields.EncodedSubject val) { this.EncodedSubject = val; }
			...
			public bool IsSet(QuickFix.Fields.EncodedSubject val) { return IsSetEncodedSubject(); }
