...
namespace QuickFix
{
	namespace FIX50SP1
	{
		public class CollateralInquiryAck : Message
		{
			...
			public CollateralInquiryAck(QuickFix.Fields.CollInquiryID aCollInquiryID,
			...
			public void Set(QuickFix.Fields.CollInquiryID val) { this.CollInquiryID = val; }
			...
			public bool IsSet(QuickFix.Fields.CollInquiryID val) { return IsSetCollInquiryID(); }
			...
			public void Set(QuickFix.Fields.CollInquiryStatus val) { this.CollInquiryStatus = val; }
			...
			public bool IsSet(QuickFix.Fields.CollInquiryStatus val) { return IsSetCollInquiryStatus(); }
			...
			public void Set(QuickFix.Fields.CollInquiryResult val) { this.CollInquiryResult = val; }
			...
			public bool IsSet(QuickFix.Fields.CollInquiryResult val) { return IsSetCollInquiryResult(); }
			...
			public void Set(QuickFix.Fields.NoCollInquiryQualifier val) { this.NoCollInquiryQualifier = val; }
			...
			public bool IsSet(QuickFix.Fields.NoCollInquiryQualifier val) { return IsSetNoCollInquiryQualifier(); }
			...
			public class NoCollInquiryQualifierGroup : Group
			{
				...
				public NoCollInquiryQualifierGroup() : base(Tags.NoCollInquiryQualifier, Tags.CollInquiryQualifier, fieldOrder)
				{
				}
			...
			public void Set(QuickFix.Fields.CollInquiryQualifier val) { this.CollInquiryQualifier = val; }
			...
			public bool IsSet(QuickFix.Fields.CollInquiryQualifier val) { return IsSetCollInquiryQualifier(); }
