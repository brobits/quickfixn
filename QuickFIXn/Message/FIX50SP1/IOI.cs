...
namespace QuickFix
{
	namespace FIX50SP1
	{
		public class IOI : Message
		{
			...
			public IOI(QuickFix.Fields.IOIID aIOIID,
			...
			public void Set(QuickFix.Fields.LegIOIQty val) { this.LegIOIQty = val; }
			...
			public bool IsSet(QuickFix.Fields.LegIOIQty val) { return IsSetLegIOIQty(); }
