...
namespace QuickFix
{
	namespace FIX42
	{
		public class QuoteAcknowledgement : Message
		{
			...
			public QuoteAcknowledgement(QuickFix.Fields.QuoteAckStatus aQuoteAckStatus)
				   : this()
			{
			...
			public void Set(QuickFix.Fields.QuoteAckStatus val) { this.QuoteAckStatus = val; }
			...
			public bool IsSet(QuickFix.Fields.QuoteAckStatus val) { return IsSetQuoteAckStatus(); }
