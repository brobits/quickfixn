...
namespace QuickFix
{
	namespace FIX50
	{
		public class CollateralReport : Message
		{
			...
			public CollateralReport(QuickFix.Fields.CollRptID aCollRptID,
			...
			public void Set(QuickFix.Fields.CollRptID val) { this.CollRptID = val; }
			...
			public bool IsSet(QuickFix.Fields.CollRptID val) { return IsSetCollRptID(); }
			...
			public void Set(QuickFix.Fields.CollStatus val) { this.CollStatus = val; }
			...
			public bool IsSet(QuickFix.Fields.CollStatus val) { return IsSetCollStatus(); }
