...
namespace QuickFix
{
	namespace FIX50
	{
		public class OrderMassStatusRequest : Message
		{
			...
			public OrderMassStatusRequest(QuickFix.Fields.MassStatusReqID aMassStatusReqID,
			...
			public void Set(QuickFix.Fields.MassStatusReqType val) { this.MassStatusReqType = val; }
			...
			public bool IsSet(QuickFix.Fields.MassStatusReqType val) { return IsSetMassStatusReqType(); }
