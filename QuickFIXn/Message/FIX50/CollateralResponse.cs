...
namespace QuickFix
{
	namespace FIX50
	{
		public class CollateralResponse : Message
		{
			...
			public CollateralResponse(QuickFix.Fields.CollRespID aCollRespID,
			...
			public void Set(QuickFix.Fields.CollRespID val) { this.CollRespID = val; }
			...
			public bool IsSet(QuickFix.Fields.CollRespID val) { return IsSetCollRespID(); }
			...
			public void Set(QuickFix.Fields.CollAsgnRespType val) { this.CollAsgnRespType = val; }
			...
			public bool IsSet(QuickFix.Fields.CollAsgnRespType val) { return IsSetCollAsgnRespType(); }
			...
			public void Set(QuickFix.Fields.CollAsgnRejectReason val) { this.CollAsgnRejectReason = val; }
			...
			public bool IsSet(QuickFix.Fields.CollAsgnRejectReason val) { return IsSetCollAsgnRejectReason(); }
			...
			public void Set(QuickFix.Fields.CollApplType val) { this.CollApplType = val; }
			...
			public bool IsSet(QuickFix.Fields.CollApplType val) { return IsSetCollApplType(); }
